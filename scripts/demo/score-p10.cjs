...
const fieldConfigs = [{"id":"ascending_order","label":"ascending order","type":"number"},{"id":"uniformly_spaced","label":"uniformly spaced","type":"number"},{"id":"proper_lashings_2_ea_20_pt","label":"Proper lashings\n(2 ea × 20 pt)","type":"number"},{"id":"tight_and_sturdy","label":"tight and sturdy","type":"number"},{"id":"secured_to_anchor_post","label":"secured to anchor post","type":"number"},{"id":"all_patrol_members_complete_the_climb_within_time_limit","label":"All patrol members complete the climb within time limit","type":"time_mm_ss"},{"id":"spirited_celebration","label":"Spirited celebration","type":"number"},{"id":"disassemble_ladder_stack_materials","label":"Disassemble ladder, \nstack materials","type":"number"},{"id":"more_than_one_scout_on_ladder_at_a_time_5_pt_each_instance","label":"More than one Scout\non ladder at a time \n(-5 pt each instance)","type":"time_mm_ss"},{"id":"time_mm_ss","label":"Time\nmm:ss","type":"time_mm_ss"},{"id":"patrol_flag","label":"Patrol Flag?","sortOrder":1,"type":"range","min":0,"max":5,"defaultValue":0},{"id":"patrol_yell","label":"Patrol Yell?","sortOrder":2,"type":"range","min":0,"max":5,"defaultValue":0},{"id":"patrol_spirit","label":"Patrol Spirit","sortOrder":3,"type":"range","min":0,"max":5,"defaultValue":0},{"id":"unscoutlike","label":"Un-Scout-like Behavior (Penalty)","sortOrder":998,"type":"number","min":0,"max":100,"helperText":"Enter POSITIVE number to deduct points","defaultValue":0},{"id":"judge_notes","label":"Judge Notes / Comments","sortOrder":999,"type":"textarea","placeholder":"Optional notes on performance..."}];
