...
async function run() {
    ...
    // 1. Select Game
    console.log("Selecting Game p7 (Colorguard Game)...");
    // Using a more robust selector since names might have special chars
    await page.click('button:has-text("Colorguard Game")');
    await sleep(waitTime);
